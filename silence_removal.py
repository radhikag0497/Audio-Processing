...
def frame_generator(frame_duration_ms, audio, sample_rate):
    ...
    """
    print("Frame Duration (ms): {}, Sample Rate: {}".format(frame_duration_ms, sample_rate))
...
def main(args):
    ...
    # print(webrtcvad.valid_rate_and_frame_length(sample_rate, type(frames)))
    frames = list(frames)
    print("After frame gen, Length of frames list:", len(frames))
